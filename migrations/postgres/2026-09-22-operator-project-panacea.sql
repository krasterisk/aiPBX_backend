...
DECLARE
    ...
    metrics jsonb := $json$[
        ...
        },
        {
            ...
            "type": "boolean",
            "polarity": "positive",
            "description": "Только если пациент явно звонит впервые: true — спросила, откуда узнали о клинике или медцентре; false — визит первый, вопрос не задан. Если это не первая запись или из диалога не ясно, что визит первый — верни null. null значит метрика не применяется и не является ошибкой."
        }
    ]$json$::jsonb;
